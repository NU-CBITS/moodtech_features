...
describe 'Do', type: [:feature], sauce: [false] do
  ...
  it '- awareness' do
    ...
    click_on 'Continue'
    page.accept_alert 'Are you sure that you would ' \
                            'like to make this activity public?'
    ...
    click_on 'Continue'
    expect(page).to have_content 'Things that make you feel ' \
  ...
  it '- awareness second time around' do
    ...
    expect(page).to have_content 'Take a look - ' \
                                    'does this all seem right? Recently, you...'
    click_on 'Continue'
    expect(page).to have_content 'Things you found fun.'
    click_on 'Continue'
    expect(page).to have_content 'Things that make you feel ' \
  ...
  # this test passes because I do not select a time in the
  # 'future_time_picker_0' - this is likely going to be updated
